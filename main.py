...
from connect_serial import ser, data,listen_to_serial_in_thread, send_data

listen_to_serial_in_thread(ser,data)
        ...
        if recognition_result_list:
            ...
            if gestures:
                ...
                if DETECTIONS.count(DETECTIONS[0]) == len(DETECTIONS):
                    ...
                    if category_name in gesture_command_map:
                        if OLD_DETECTION != category_name:
                            print(gesture_command_map[category_name])
                            send_data(gesture_command_map[category_name])
                            OLD_DETECTION = category_name
